...
LISTING_URLS = [
  "https://www.long-mcquade.com/rentals/pa/0/21/37/",
  "https://www.long-mcquade.com/?page=rentals&PageName=pa&SubDepartmentID=37&Current=20#top-pagination"

].freeze

  CATEGORY_NAME = "lights & Fog"

  OUTPUT_FILENAME = "long_mcquade_lights_fog.json"
